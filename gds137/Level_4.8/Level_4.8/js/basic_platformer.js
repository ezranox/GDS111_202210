...
function animate()
{
	...
	while(platform1.hitTestPoint(player.right()) && player.vx >=0)
	{
		...
		// If I collect the key (goal/ pearl) I want it to be able to unlock the door. *CANT ERASE ON JS* SO just move platform off screen 
		//platform1.x = 10000 (Just like  when we collect the key and move it off screen)
	...
	if(player.hitTestObject(goal)) //Goal IS the KEY!!
	{
		goal.y = 10000; 
		key = true;
	}
