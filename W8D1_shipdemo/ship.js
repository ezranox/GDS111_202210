//JS file to creat a ship in the HTML canvas
function Ship() {

    //the 'this' keyword refrences the current objet you are inside of (in the code block) EVERYTHING in Javascript is an onject when we say 'this' we are talking about Ship()

    this.x = 100 //x-axis coord start position
    this.y= 100 //yaxis coord start position
    ...
    this.move = function () {
        ...
        this.x += this.vx //adds velocity to value to x coord point 
...
this.draw = function() {
  ...
  /*  //save the current state of the canvas
    ...
    //start point at current spot desgignated on line 32
    context.beginPath()
