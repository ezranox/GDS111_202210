// JS file that runs the game and coonects the functionality of ship.js and controls.js to the HTML
...
//move and redraw the ship! .functions() are from a ship.js [Ship()]
ship.move()
ship.draw()
