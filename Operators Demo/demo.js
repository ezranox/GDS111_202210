...
function shoot() {
    ...
    if (currentAmmo > 0){
        ...
        //long math way 9right of = happens FIRST, storage happens right to left)
...
//functions can also be PASSED VALUES; these values are called PARAMETERS and must be sent to the function during the during the call in order for the function to work (func relies on this data to do its job!)
